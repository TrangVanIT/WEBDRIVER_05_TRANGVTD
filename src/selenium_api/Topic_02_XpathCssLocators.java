...
public class Topic_02_XpathCssLocators 
{
  ...
  public void LoginEmpty()
  {
	  ...
	  //Get error message at Email field and Verify error message xuất hiện tại Email field:
	  ...
	  //Get error message at Password field and Verify error message xuất hiện tại Password field:
  ...
  public void CreateAccount () throws InterruptedException 
  {
	  ...
	  // Verify error message 
	  WebElement Success_message = driver.findElement(By.xpath("//div[@class='page']//li[@class='success-msg']//span"));
